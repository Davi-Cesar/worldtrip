...
export default function Europa() {
  ...
  return (
    <>
      ...
      {isWideVersion ? (
        <>
          <Flex w="100%" h="100%" objectFit="contain" direction="column">
        ...
        <>
          <Flex direction="column" h="2024px">
            <Box p="24px" w="100%" h="250px">
              <Text textAlign="justify" h="250px" fontSize="1xs">
                A Europa é, por convenção, um dos seis continentes do mundo.
                Compreendendo a península ocidental da Eurásia, a Europa
            ...
            <HStack textAlign="center" h="100px" p="24px">
              <Box w="100%">
                <Box fontWeight="medium">
                  <Text color="yellow.500" fontWeight="medium" fontSize="2xl">
                    50
                  </Text>
                  países
                </Box>
              ...
              <Box w="100%">
                <Box fontWeight="medium">
                  <Text color="yellow.500" fontWeight="medium" fontSize="24px">
                    60
                  </Text>
                  línguas
                </Box>
            ...
            <Box h="100%" w="100%" margin="0 auto" p="24px">
              <Text p="5px 0px 5px 0px" fontSize="24px" fontWeight="semibold">
                Cidades +100
              </Text>
              <Flex direction="column">
                <Stack spacing={"24px"} padding="24px" w="100%">
                  <City
                    image="https://s3-alpha-sig.figma.com/img/1db8/ec22/64a5ba2142d081c49ed2ecccb92bc064?Expires=1679875200&Signature=m8nGV~NHAlT4li4wUp-UadW71FVJsD3pFHd5j5EfckuvkyBCC7kJLPFkd8Pia5RJs06ie8aVM1s2AlTr9eJsshFTdaid4rnaRbUVuqNIf5aiFFdbz5LezNCFHlDaC-w2nBiFJ6D9sJ2h2p0m8vwFMvtD9haRKvP1u~UU-yukBKTjL7GcNPNpjbw0HzqUYJhnfcUU4sCeO1NGqpFUQ~sML0MO-2rMas-yIOSfVA6JUh1Pbh-r9HJjPTMGnX1gATMSAxqIb0OevZxXyelKc7Tr1MDQdpEuNPrJdjJhszBBbHdEOhzJE4obqs2psap42AYbydbFx0ui7sG60ooGgq9~LA__&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4"
                    name="Londres"
                    country="Reino Unido"
